...
const timeSlot = () => "../../../components/wanghexu-timeslot/wanghexu-timeslot.js";
const _sfc_main = {
  components: {
    timeSlot
  },
...
if (!Array) {
  ...
  const _component_timeSlot = common_vendor.resolveComponent("timeSlot");
  (_easycom_uni_datetime_picker2 + _component_timeSlot)();
}
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    e: common_vendor.t($data.single + $data.time || "None"),
    f: common_vendor.sr("timeslot", "742710c6-1"),
    g: common_vendor.o($options.confirmTime),
    h: common_vendor.p({
      title: "Choose the time"
    })
  };
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/prosperous/Desktop/SE/mobile_frontend/pages/facilities/find/index.vue"]]);
